...
""") % (mesh_dir, scale_values[0], scale_values[1], scale_values[2], mesh_dir, scale_values[0], scale_values[1],
        scale_values[2])
    return urdf_str
        ...
        for l1 in dim_values:
            for l2 in dim_values[:max_grasp_dim_idx + 1]:
                for l3 in dim_values:
                    ...
                    # mesh_dir = "sq_" + str(max_dim) + "_" + str(max_dim) + "_" + str(max_dim) + "_" + str(
                    #     l4) + "_" + str(l5)
                    obj_dir = '.'
                    mesh_dir = 'a1/stopsign.obj'
