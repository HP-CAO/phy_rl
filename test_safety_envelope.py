...
plt.vlines(x=-0.9, ymin=-0.85, ymax=0.85, color='black', linewidth=1.5)
plt.vlines(x=0.9, ymin=-0.85, ymax=0.85, color='black', linewidth=1.5)
plt.hlines(y=-0.8, xmin=-0.95, xmax=0.95, color='black', linewidth=1.5)
plt.hlines(y=0.8, xmin=-0.95, xmax=0.95, color='black', linewidth=1.5)

# Loading model
params = read_config("./config/eval.json")
model_path = "./nips_unk_our_with_res_1_best"
model_path_ubc = "./nips_unk_ubc_no_res_1_best"
